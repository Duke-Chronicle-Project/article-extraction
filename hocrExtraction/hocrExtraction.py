...
sampleInput.hocr generated using tesseract 4.1.1 command `tesseract alice_1.png sampleInput hocr`
'''
...
def parseAttrib(attributes):
    ...
    if attributes['class'] == 'ocrx_word':
        ...
        return wordBbox, wordConf, wordNum
...
def parseHOCR(path, save=False):
            ...
            for paragraph in colArea.xpath("./*[@class='ocr_par']"):
                ...
                for line in paragraph.xpath("./*[@class='ocr_line']"):
                    ...
                    for word in line.xpath("./*[@class='ocrx_word']"):
                        wordBbox, wordConf, wordNum = parseAttrib(word.attrib)

                        final.append((word.text, wordConf, wordNum, wordBbox[0], wordBbox[1], wordBbox[2], wordBbox[3],
    ...
    df = pd.DataFrame(final, columns=['word', 'conf', 'wordNum', 'wordX0', 'wordY0', 'wordX1', 'wordY1',
